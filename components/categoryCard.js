        ...
        <div><br></br><hr></hr></div>
            <div className="container mx-auto p-6 grid grid-cols-1 gap-y-10 sm:grid-cols-2 gap-x-6 lg:grid-cols-3 xl:gap-x-8">
                {categoriesList.map((category) => (
                    <div key={category.topics_category_id} className=" bg-white rounded-xl text-center col-span-1 flex flex-col border-2 p-4">
                        ...
                        <br></br>
                        <a href={"/categories/" + category.topics_category_id} className="m-4 mt-auto inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-500 rounded-lg hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Read more
