            ...
            <div className="container mx-auto p-6 grid grid-cols-1 gap-y-10 sm:grid-cols-2 gap-x-6 lg:grid-cols-3 xl:gap-x-8">
                {categoriesList.map((category) => (
                    <div key={category.contents_type_nm} className="group odd:bg-teal-100 even:bg-teal-200 hover:bg-emerald-400 hover:text-white rounded-xl text-center col-span-1 flex flex-col bg-white border-2 p-4">
                        ...
                        <p className="text-md">{category.contents_type_ext_col_02}</p>
                        <br></br>
                        <a href={"/categories/" + category.contents_type} className="m-4 mt-auto inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-500 rounded-lg hover:bg-blue-900 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Read more
